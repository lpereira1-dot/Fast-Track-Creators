...
_ALL_TEMPLATES = [
    lambda cfg, today: templates.welcome_email(cfg),
    lambda cfg, today: templates.sale_reminder_email(cfg),
...
def test_copyright_footer_uses_the_provided_year():
    cfg = _config()
    _subject, body = templates.post_reminder_email(cfg, date(2027, 1, 1))
